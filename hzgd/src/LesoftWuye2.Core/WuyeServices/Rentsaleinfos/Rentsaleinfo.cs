...
{
    [Table("Rentsaleinfos")]
    [EntityDescription("租售信息")]
    public class Rentsaleinfo : AuditedEntity<long>
    {
        ...
        public long RentsaleinfoTypeId { get; set; }

        [ForeignKey("RentsaleinfoTypeId")]
        public virtual RentsaleinfoType Type { get; set; }
        ...
        [Display(Name = "来源")]
        public virtual RentsaleinfoSource Source { get; set; }
