...
using Obs.Users;
using LesoftWuye2.Web.Controllers.Results;
using LesoftWuye2.Web.Models.Account;
...
{
    public class AccountController : LesoftWuye2ControllerBase
    {
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = Obs.Users.User.CreateRandomPassword();
