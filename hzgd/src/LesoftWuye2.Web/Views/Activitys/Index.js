...
(function () {
    $(function () {
        ...
        //通用添加数据
		var commonCreate = new CommonCreateModel($('#ActivityCreateModal'), abp.services.app.activity.createActivity);
		commonCreate.init();
		...
		$(commonCreate).bind('preSubmit', function (obj, arg) {
		    ...
		    var projects = $('form[name="activityCreateForm"').find('select[name="projects"]').val();
        ...
        //通用删除数据
		var commdel = new CommonDeleteData(abp.services.app.activity.deleteActivity);
        ...
        //通用修改(先获取单条数据再修改)
		var commonUpdate = new CommonUpdateModel($('#ActivityUpdateModal'), abp.services.app.activity.getActivity, abp.services.app.activity.updateActivity);
		commonUpdate.init();
		...
		$(commonUpdate).bind('preSubmit', function (obj, arg) {
		    ...
		    var projects = $('form[name="activityUpdateForm"').find('select[name="projects"]').val();
