...
(function () {
    $(function () {
        ...
        //通用添加数据
        new CommonCreateModel($('#RentsaleinfoTypeCreateModal'), abp.services.app.rentsaleinfoType.createRentsaleinfoType).init();

        //通用删除数据
        var commdel = new CommonDeleteData(abp.services.app.rentsaleinfoType.deleteRentsaleinfoType);
        ...
        //通用修改(先获取单条数据再修改)
        var commonUpdate = new CommonUpdateModel($('#RentsaleinfoTypeUpdateModal'), abp.services.app.rentsaleinfoType.getRentsaleinfoType, abp.services.app.rentsaleinfoType.updateRentsaleinfoType);
        commonUpdate.init();
