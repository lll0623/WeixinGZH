...
(function () {
    $(function () {
        ...
        //通用添加数据
        new CommonCreateModel($('#CategoryCreateModal'), abp.services.app.category.createCategory).init();

        //通用删除数据
        var commdel = new CommonDeleteData(abp.services.app.category.deleteCategory);
        ...
        //通用修改(先获取单条数据再修改)
        var commonUpdate = new CommonUpdateModel($('#CategoryUpdateModal'), abp.services.app.category.getCategory, abp.services.app.category.updateCategory);
        commonUpdate.init();
