...
(function () {
    $(function () {
        ...
        //通用添加数据
        new CommonCreateModel($('#EstateinfoTypeCreateModal'), abp.services.app.estateinfoType.createEstateinfoType).init();

        //通用删除数据
        var commdel = new CommonDeleteData(abp.services.app.estateinfoType.deleteEstateinfoType);
        ...
        //通用修改(先获取单条数据再修改)
        var commonUpdate = new CommonUpdateModel($('#EstateinfoTypeUpdateModal'), abp.services.app.estateinfoType.getEstateinfoType, abp.services.app.estateinfoType.updateEstateinfoType);
        commonUpdate.init();
