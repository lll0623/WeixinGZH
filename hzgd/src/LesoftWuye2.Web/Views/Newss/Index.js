...
(function () {
    ...
    $(function () {
        ...
        //通用添加数据
		var commonCreate = new CommonCreateModel($('#NewsCreateModal'), abp.services.app.news.createNews);
		commonCreate.init();
        ...
        //通用删除数据
        var commdel = new CommonDeleteData(abp.services.app.news.deleteNews);
        ...
        //通用修改(先获取单条数据再修改)
        var commonUpdate = new CommonUpdateModel($('#NewsUpdateModal'), abp.services.app.news.getNews, abp.services.app.news.updateNews);
        commonUpdate.init();
        ...
        $(commonUpdate).bind('preSubmit', function (obj, arg) {
            ...
            var projects = $('form[name="newsUpdateForm"').find('select[name="projects"]').val();
