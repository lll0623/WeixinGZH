...
(function () {
    $(function () {
        ...
        //通用添加数据
        new CommonCreateModel($('#PlateCreateModal'), abp.services.app.plate.createPlate).init();

        //通用删除数据
        var commdel = new CommonDeleteData(abp.services.app.plate.deletePlate);
        ...
        //通用修改(先获取单条数据再修改)
        var commonUpdate = new CommonUpdateModel($('#PlateUpdateModal'), abp.services.app.plate.getPlate, abp.services.app.plate.updatePlate);
        commonUpdate.init();
