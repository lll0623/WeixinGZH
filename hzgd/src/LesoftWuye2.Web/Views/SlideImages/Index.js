...
(function () {
    $(function () {
        ...
        //通用添加数据
        new CommonCreateModel($('#SlideImageCreateModal'), abp.services.app.slideImage.createSlideImage).init();

        //通用删除数据
        var commdel = new CommonDeleteData(abp.services.app.slideImage.deleteSlideImage);
        ...
        //通用修改(先获取单条数据再修改)
        var commonUpdate = new CommonUpdateModel($('#SlideImageUpdateModal'), abp.services.app.slideImage.getSlideImage, abp.services.app.slideImage.updateSlideImage);
        commonUpdate.init();
